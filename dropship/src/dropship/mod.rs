...
pub const DCBF_LINK: &str = "https://gall.dcinside.com/mgallery/board/lists/?id=battlefield";
pub const GITHUB2_URI: &str = "https://github.com/eeeeeeno17/dropship-bf6-v3";