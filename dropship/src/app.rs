    ...
    fn ui(&mut self, ui: &mut egui::Ui, frame: &mut eframe::Frame) {
                ...
                egui::Sides::new().show(
                    ...
                    |ui| {
                        ...
                        ui.with_layout(egui::Layout::top_down(egui::Align::LEFT), |ui| {
                            ...
                            .on_hover_text_at_pointer(dropship::DCBF_LINK);
        ...
        if !self.config.mini {
            ...
            .show(ui, |ui| {
                ...
                ui.label("this configuration will be applied to the selected applications above. you do not need to keep this window open. However, if you use the 'only while dropship is open' setting, the window must remain open. You can check the approximate ping of a server by hovering your mouse cursor over it.");
...
impl TemplateApp {
    ...
    fn help_wizard(&mut self, ui: &mut egui::Ui) {
        ui.label("if something's not working, you can ask for help to eeeeeno :3");
        ui.horizontal(|ui| {
            ui.label("  •");
        ...
        ui.label("BF6 Dropship Source code");
        ui.horizontal(|ui| {
            ui.label("  •");
            // ui.hyperlink_to("discord", dropship::DISCORD_INVITE_LINK);
    ...
    fn welcome(&mut self, ui: &mut egui::Ui, page: u8) {
        ...
        let modal = egui::Modal::new(egui::Id::new("welcome")).show(ui.ctx(), |ui| {
            ...
            match page {
                0 => {
                    ui.heading("bf6 server selector");
                    ui.label(
                        "this app grants you control over which bf6 servers you play on",
                    );
                    ...
                    ui.indent("xd", |ui| {
                        ...
                        ui.label("• break EA terms of service");
                    });
                ...
                _ => {
                    ...
                    ui.label("if something's not working, you can ask for help to DCBF");
                    ui.horizontal(|ui| {
                        ui.label("  •");
