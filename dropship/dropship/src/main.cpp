...
int main(int, char**)
{
    ...
    */
    ...
    try {
        ...
        //g_process_watcher = std::make_unique<ProcessWatcher>("bf6.exe");
        g_window_watcher = std::make_unique<util::watcher::window::WindowWatcher>("Battlefield™ 6");
